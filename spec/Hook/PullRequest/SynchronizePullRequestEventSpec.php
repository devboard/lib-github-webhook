...
class SynchronizePullRequestEventSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(SynchronizePullRequestEvent::class);
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(SynchronizePullRequestEvent::class);
    }
}
