...
class MergedPullRequestEventSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(MergedPullRequestEvent::class);
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(MergedPullRequestEvent::class);
    }
}
