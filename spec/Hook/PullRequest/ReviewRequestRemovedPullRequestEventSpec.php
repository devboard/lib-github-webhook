...
class ReviewRequestRemovedPullRequestEventSpec extends ObjectBehavior
{
    public function let(
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(ReviewRequestRemovedPullRequestEvent::class);
    }
}
