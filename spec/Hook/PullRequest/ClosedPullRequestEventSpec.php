...
class ClosedPullRequestEventSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ClosedPullRequestEvent::class);
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(ClosedPullRequestEvent::class);
    }
}
