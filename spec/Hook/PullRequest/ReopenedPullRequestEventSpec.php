...
class ReopenedPullRequestEventSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ReopenedPullRequestEvent::class);
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(ReopenedPullRequestEvent::class);
    }
}
