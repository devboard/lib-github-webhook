...
class OpenedPullRequestEventSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(OpenedPullRequestEvent::class);
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(OpenedPullRequestEvent::class);
    }
}
