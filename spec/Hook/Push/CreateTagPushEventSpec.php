 ...
 */
class CreateTagPushEventSpec extends ObjectBehavior
{
    public function let(
        Ref $ref,
        CommitSha $after,
        ...
        $this->beConstructedWith(
            $ref, $after, $baseRef, $changesUrl, $commits, $headCommit, $repo, $forced = false, $pusher, $sender
        );
    }

    public function it_is_initializable()
    {
        $this->shouldHaveType(CreateTagPushEvent::class);
    ...
    public function it_can_be_serialized(
        ...
        $ref->serialize()->shouldBeCalled()->willReturn('refs/heads/new-feature-tag');
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(CreateTagPushEvent::class);
    }
}
