 ...
 */
class CreateBranchPushEventSpec extends ObjectBehavior
{
    public function let(
        Ref $ref,
        CommitSha $after,
    ...
    {
        $this->shouldHaveType(CreateBranchPushEvent::class);
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(CreateBranchPushEvent::class);
    }
}
