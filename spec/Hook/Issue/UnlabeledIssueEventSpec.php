...
class UnlabeledIssueEventSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(UnlabeledIssueEvent::class);
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(UnlabeledIssueEvent::class);
    }
}
