...
class EditedIssueEventSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(EditedIssueEvent::class);
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(EditedIssueEvent::class);
    }
}
