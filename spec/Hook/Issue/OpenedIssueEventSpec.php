...
class OpenedIssueEventSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(OpenedIssueEvent::class);
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(OpenedIssueEvent::class);
    }
}
