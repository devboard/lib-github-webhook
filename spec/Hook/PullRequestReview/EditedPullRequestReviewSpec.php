...
class EditedPullRequestReviewSpec extends ObjectBehavior
{
    public function let(
    ...
    {
        $this->shouldHaveType(EditedPullRequestReview::class);
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(EditedPullRequestReview::class);
    }
}
