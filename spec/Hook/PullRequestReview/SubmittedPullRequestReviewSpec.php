...
class SubmittedPullRequestReviewSpec extends ObjectBehavior
{
    public function let(
    ...
    {
        $this->shouldHaveType(SubmittedPullRequestReview::class);
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(SubmittedPullRequestReview::class);
    }
}
