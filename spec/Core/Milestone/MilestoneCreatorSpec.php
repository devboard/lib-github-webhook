...
class MilestoneCreatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(MilestoneCreator::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(MilestoneCreator::class);
    }
}
