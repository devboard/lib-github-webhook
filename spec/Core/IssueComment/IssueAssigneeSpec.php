...
class IssueAssigneeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(IssueAssignee::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(IssueAssignee::class);
    }
}
