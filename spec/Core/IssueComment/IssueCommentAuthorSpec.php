...
class IssueCommentAuthorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(IssueCommentAuthor::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(IssueCommentAuthor::class);
    }
}
