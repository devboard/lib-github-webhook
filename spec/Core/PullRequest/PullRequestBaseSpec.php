...
{
    public function let(BranchName $targetBranchName, Repo $repo, CommitSha $sha)
    {
    ...
    public function it_can_be_serialized(BranchName $targetBranchName, Repo $repo, CommitSha $sha)
    {
