 ...
 * @covers \DevboardLib\GitHubWebhook\Hook\PullRequestReview\EditedPullRequestReview
 * @group  todo
 */
class EditedPullRequestReviewTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->sut            = new EditedPullRequestReview(
    ...
    public function testDeserialize(): void
    {
        ...
        self::assertEquals($this->sut, EditedPullRequestReview::deserialize(json_decode($serialized, true)));
    }
}
