 ...
 * @covers \DevboardLib\GitHubWebhook\Hook\IssueComment\CreatedIssueCommentEvent
 * @group  unit
 */
class CreatedIssueCommentEventTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut            = new CreatedIssueCommentEvent(
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, CreatedIssueCommentEvent::deserialize(json_decode($serialized, true)));
    }
}
