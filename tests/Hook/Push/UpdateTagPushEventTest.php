 ...
 * @covers \DevboardLib\GitHubWebhook\Hook\Push\UpdateTagPushEvent
 * @group  unit
 */
class UpdateTagPushEventTest extends TestCase
{
    /** @var Ref */
    private $ref;
    ...
    public function setUp()
    {
        ...
        $this->sut        = new UpdateTagPushEvent(
            $this->ref,
            $this->before,
            $this->after,
            $this->baseRef,
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, UpdateTagPushEvent::deserialize(json_decode($serialized, true)));
    }
}
