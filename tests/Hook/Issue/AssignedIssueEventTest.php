 ...
 * @covers \DevboardLib\GitHubWebhook\Hook\Issue\AssignedIssueEvent
 * @group  unit
 */
class AssignedIssueEventTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut            = new AssignedIssueEvent($this->issue, $this->repo, $this->installationId, $this->sender);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, AssignedIssueEvent::deserialize(json_decode($serialized, true)));
    }
}
