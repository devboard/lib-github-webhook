 ...
 * @covers \DevboardLib\GitHubWebhook\Hook\Issue\UnlabeledIssueEvent
 * @group  todo
 */
class UnlabeledIssueEventTest extends TestCase
{
    /** @var GitHubIssue */
    private $issue;
    ...
    public function setUp()
    {
        ...
        $this->sut            = new UnlabeledIssueEvent($this->issue, $this->repo, $this->installationId, $this->sender);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, UnlabeledIssueEvent::deserialize(json_decode($serialized, true)));
    }
}
