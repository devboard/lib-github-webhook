 ...
 * @covers \DevboardLib\GitHubWebhook\Hook\Issue\UnassignedIssueEvent
 * @group  unit
 */
class UnassignedIssueEventTest extends TestCase
{
    /** @var GitHubIssue */
    private $issue;
    ...
    public function setUp()
    {
        ...
        $this->sut            = new UnassignedIssueEvent($this->issue, $this->repo, $this->installationId, $this->sender);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, UnassignedIssueEvent::deserialize(json_decode($serialized, true)));
    }
}
