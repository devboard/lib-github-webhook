...
class LabeledIssueEventTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut            = new LabeledIssueEvent($this->issue, $this->repo, $this->installationId, $this->sender);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, LabeledIssueEvent::deserialize(json_decode($serialized, true)));
    }
}
