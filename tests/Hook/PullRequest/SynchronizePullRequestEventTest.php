 ...
 * @covers \DevboardLib\GitHubWebhook\Hook\PullRequest\SynchronizePullRequestEvent
 * @group  unit
 */
class SynchronizePullRequestEventTest extends TestCase
{
    /** @var PullRequest */
    private $pullRequest;
    ...
    /** @var SynchronizePullRequestEvent */
    private $sut;
    ...
    public function setUp()
    {
        ...
        $this->sut            = new SynchronizePullRequestEvent(
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, SynchronizePullRequestEvent::deserialize(json_decode($serialized, true)));
    }
}
