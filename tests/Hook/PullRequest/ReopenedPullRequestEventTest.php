 ...
 * @covers \DevboardLib\GitHubWebhook\Hook\PullRequest\ReopenedPullRequestEvent
 * @group  unit
 */
class ReopenedPullRequestEventTest extends TestCase
{
    /** @var PullRequest */
    private $pullRequest;
    ...
    public function setUp()
    {
        ...
        $this->sut            = new ReopenedPullRequestEvent(
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, ReopenedPullRequestEvent::deserialize(json_decode($serialized, true)));
    }
}
