 ...
 * @covers \DevboardLib\GitHubWebhook\Hook\PullRequest\UnlabeledPullRequestEvent
 * @group  unit
 */
class UnlabeledPullRequestEventTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut            = new UnlabeledPullRequestEvent(
