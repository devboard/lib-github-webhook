 ...
 * @covers \DevboardLib\GitHubWebhook\Hook\PullRequest\EditedPullRequestEvent
 * @group  unit
 */
class EditedPullRequestEventTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut            = new EditedPullRequestEvent($this->pullRequest, $this->repo, $this->installationId, $this->sender);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, EditedPullRequestEvent::deserialize(json_decode($serialized, true)));
    }
}
