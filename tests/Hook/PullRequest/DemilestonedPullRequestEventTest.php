 ...
 * @group  unit
 */
class DemilestonedPullRequestEventTest extends TestCase
{
    /** @var PullRequest */
    private $pullRequest;
    ...
    /** @var DemilestonedPullRequestEvent */
    private $sut;
    ...
    public function setUp()
    {
        ...
        $this->sut            = new DemilestonedPullRequestEvent(
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, DemilestonedPullRequestEvent::deserialize(json_decode($serialized, true)));
    }
}
