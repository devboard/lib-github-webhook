...
/**
 * @covers \DevboardLib\GitHubWebhook\Core\Milestone\MilestoneCreator
 * @group  todo
 */
class MilestoneCreatorTest extends TestCase
{
    /** @var AccountId */
    private $userId;
    ...
    public function setUp(): void
    {
        ...
        $this->sut       = new MilestoneCreator($this->userId, $this->login, $this->type, $this->avatarUrl, $this->siteAdmin);
    }
    ...
    public function testDeserialize(): void
    {
        ...
        self::assertEquals($this->sut, MilestoneCreator::deserialize(json_decode($serialized, true)));
    }
}
