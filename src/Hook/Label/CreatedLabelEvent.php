...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\Label\CreatedLabelEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\Label\CreatedLabelEventTest
 */
class CreatedLabelEvent implements LabelEvent
{
    /** @var GitHubLabel */
    private $label;
