...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\Label\EditedLabelEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\Label\EditedLabelEventTest
 */
class EditedLabelEvent implements LabelEvent
{
    /** @var GitHubLabel */
    private $label;
