...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\Push\UpdateBranchPushEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\Push\UpdateBranchPushEventTest
 */
class UpdateBranchPushEvent implements PushEvent
{
    /** @var Ref */
    private $ref;
