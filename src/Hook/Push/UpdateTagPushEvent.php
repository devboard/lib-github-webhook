...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\Push\UpdateTagPushEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\Push\UpdateTagPushEventTest
 */
class UpdateTagPushEvent implements PushEvent
{
    /** @var Ref */
    private $ref;
