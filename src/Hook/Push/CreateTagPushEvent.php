...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\Push\CreateTagPushEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\Push\CreateTagPushEventTest
 */
class CreateTagPushEvent implements PushEvent
{
    /** @var Ref */
    private $ref;
