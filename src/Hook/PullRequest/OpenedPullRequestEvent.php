...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\PullRequest\OpenedPullRequestEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\PullRequest\OpenedPullRequestEventTest
 */
class OpenedPullRequestEvent implements PullRequestEvent
{
    /** @var PullRequest */
    private $pullRequest;
