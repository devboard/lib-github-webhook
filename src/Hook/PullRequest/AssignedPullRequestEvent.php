...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\PullRequest\AssignedPullRequestEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\PullRequest\AssignedPullRequestEventTest
 */
class AssignedPullRequestEvent implements PullRequestEvent
{
    /** @var PullRequest */
    private $pullRequest;
    ...
    public function getAssigneeId(): AccountId
    {
        return $this->assignee->getUserId();
    }
