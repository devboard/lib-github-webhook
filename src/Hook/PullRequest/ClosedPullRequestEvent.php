...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\PullRequest\ClosedPullRequestEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\PullRequest\ClosedPullRequestEventTest
 */
class ClosedPullRequestEvent implements PullRequestEvent
{
    /** @var PullRequest */
    private $pullRequest;
