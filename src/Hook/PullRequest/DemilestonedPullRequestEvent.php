...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\PullRequest\DemilestonedPullRequestEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\PullRequest\DemilestonedPullRequestEventTest
 */
class DemilestonedPullRequestEvent implements PullRequestEvent
{
    /** @var PullRequest */
    private $pullRequest;
