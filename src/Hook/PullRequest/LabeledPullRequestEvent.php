...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\PullRequest\LabeledPullRequestEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\PullRequest\LabeledPullRequestEventTest
 */
class LabeledPullRequestEvent implements PullRequestEvent
{
    /** @var PullRequest */
    private $pullRequest;
