...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\PullRequest\MergedPullRequestEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\PullRequest\MergedPullRequestEventTest
 */
class MergedPullRequestEvent implements PullRequestEvent
{
    /** @var PullRequest */
    private $pullRequest;
