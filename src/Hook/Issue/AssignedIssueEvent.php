...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\Issue\AssignedIssueEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\Issue\AssignedIssueEventTest
 */
class AssignedIssueEvent implements IssueEvent
{
    /** @var IssueDetails */
    private $issue;
