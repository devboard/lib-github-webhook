...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\Issue\UnassignedIssueEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\Issue\UnassignedIssueEventTest
 */
class UnassignedIssueEvent implements IssueEvent
{
    /** @var IssueDetails */
    private $issue;
