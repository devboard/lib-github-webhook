...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\Issue\ClosedIssueEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\Issue\ClosedIssueEventTest
 */
class ClosedIssueEvent implements IssueEvent
{
    /** @var GitHubIssue */
    private $issue;
