...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\Issue\EditedIssueEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\Issue\EditedIssueEventTest
 */
class EditedIssueEvent implements IssueEvent
{
    /** @var GitHubIssue */
    private $issue;
