...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Hook\Issue\LabeledIssueEventSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Hook\Issue\LabeledIssueEventTest
 */
class LabeledIssueEvent implements IssueEvent
{
    /** @var GitHubIssue */
    private $issue;
