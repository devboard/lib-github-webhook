...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Core\Status\CommitCommitterDetailsSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Core\Status\CommitCommitterDetailsTest
 */
class CommitCommitterDetails implements CommitAuthor
{
    /** @var AccountId */
    private $userId;
