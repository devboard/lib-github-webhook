...
/**
 * @see \spec\DevboardLib\GitHubWebhook\Core\IssueComment\IssueCommentAuthorSpec
 * @see \Tests\DevboardLib\GitHubWebhook\Core\IssueComment\IssueCommentAuthorTest
 */
class IssueCommentAuthor
{
    /** @var AccountId */
    private $userId;
